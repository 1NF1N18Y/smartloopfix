 ...
 *  We have 4 times smaller block times in Halfy, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Halfy Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // HALFY this code also handles non-TXs (Halfy specific messages)

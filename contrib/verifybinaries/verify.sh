...
RCSUBDIR="test"
HOST1="https://github.com/Halfyproject/releases/download/v"
HOST2="https://pasta.keybase.pub/Halfy-Core-Releases/"
BASEDIR=""
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Halfy Core binary release signing key installed?"
   fi

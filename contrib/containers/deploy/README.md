...
official/supported Docker Images found at https://hub.docker.com/r/halfypay/halfyd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/halfypay/halfyd-develop/ when changing the above text**
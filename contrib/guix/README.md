# Bootstrappable Halfy Core Builds

This directory contains the files necessary to perform bootstrappable Halfy
Core builds.
...
To build Halfy Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Halfy Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/halfy-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/halfypay/guix.sigs).
...
[guix-docker]: https://github.com/Halfyproject/tree/master/contrib/guix/Dockerfile

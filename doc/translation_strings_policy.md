...
This document provides guidelines for internationalization of the Halfy Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `halfy_en.ts` remains unchanged.

# Support for Output Descriptors in Halfy Core

Since Halfy Core v0.17, there is support for Output Descriptors. This is a
...
existing Halfy Core wallets, a convenience function `combo` is
...
All RPCs in Halfy Core will include the checksum in their output. Only

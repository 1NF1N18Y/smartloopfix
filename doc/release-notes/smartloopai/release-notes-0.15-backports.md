...
- [`595826ad6`](https://github.com/Halfyproject/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`b451094e2`](https://github.com/Halfyproject/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`9a5b798e9`](https://github.com/Halfyproject/commit/9a5b798e9) Merge #10957: Avoid returning a BIP9Stats object with uninitialized values
...
- [`74325db11`](https://github.com/Halfyproject/commit/74325db11) Merge #10859: RPC: gettxout: Slightly improve doc and tests
...
- [`1f06ecdd5`](https://github.com/Halfyproject/commit/1f06ecdd5) add gargs
...
- [`c84970899`](https://github.com/Halfyproject/commit/c84970899) Merge #10706: Improve wallet fee logic and fix GUI bugs
...
- [`e5c94eea0`](https://github.com/Halfyproject/commit/e5c94eea0) Merge #10765: Tests: address placement should be deterministic by default
...
- [`33807c8ce`](https://github.com/Halfyproject/commit/33807c8ce) Merge #11000: test: Add resendwallettransactions functional tests
...
- [`6320d516b`](https://github.com/Halfyproject/commit/6320d516b) Merge #10535: [qa] fundrawtx: Fix shutdown race
...
- [`526036ead`](https://github.com/Halfyproject/commit/526036ead) Merge #9804: Fixes subscript 0 (&var[0]) where should use (var.data()) instead.
...
- [`8677d7599`](https://github.com/Halfyproject/commit/8677d7599) Merge #9176: Globals: Pass Consensus::Params through CBlockTreeDB::LoadBlockIndexGuts()
...
- [`ab02a4335`](https://github.com/Halfyproject/commit/ab02a4335) Merge #9738: gettxoutproof() should return consistent result
...
- [`42985c31b`](https://github.com/Halfyproject/commit/42985c31b) Merge #10463: Names: BIP9 vs versionbits
...
- [`5a760dd90`](https://github.com/Halfyproject/commit/5a760dd90) remove duplicate code
...
- [`d84660729`](https://github.com/Halfyproject/commit/d84660729) Merge #7522: Bugfix: Only use git for build info if the repository is actually the right one
...
- [`32c0e0f9b`](https://github.com/Halfyproject/commit/32c0e0f9b) Merge #10325: 0.15.0 Depends Updates
...
- [`05139e3eb`](https://github.com/Halfyproject/commit/05139e3eb) remove MyNodeConnCB Class and references
...
- [`6fb286686`](https://github.com/Halfyproject/commit/6fb286686) Merge #10229: Tests: Add test for getdifficulty
...
- [`c8a565d6e`](https://github.com/Halfyproject/commit/c8a565d6e) Merge #10090: Update bitcoin.conf with example for pruning
...
- [`2aa3f890d`](https://github.com/Halfyproject/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
...
- [`317b797e2`](https://github.com/Halfyproject/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/Halfyproject/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/Halfyproject/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/Halfyproject/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/Halfyproject/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/Halfyproject/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/Halfyproject/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/Halfyproject/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/Halfyproject/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/Halfyproject/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/Halfyproject/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/Halfyproject/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/Halfyproject/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/Halfyproject/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/Halfyproject/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/Halfyproject/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/Halfyproject/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/Halfyproject/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/Halfyproject/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/Halfyproject/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/Halfyproject/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/Halfyproject/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/Halfyproject/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/Halfyproject/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/Halfyproject/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/Halfyproject/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/Halfyproject/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/Halfyproject/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/Halfyproject/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/Halfyproject/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/Halfyproject/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/Halfyproject/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/Halfyproject/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/Halfyproject/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/Halfyproject/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/Halfyproject/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/Halfyproject/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/Halfyproject/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/Halfyproject/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/Halfyproject/commit/1cfda206a) Merge #9993: Initialize nRelockTime

...
At the first startup Halfy Core will run a migration process which can take
...
incompatible with older versions of Halfy Core, so a db migration path was
...
See detailed [set of changes](https://github.com/Halfyproject/compare/v19.1.0...halfypay:v19.2.0).

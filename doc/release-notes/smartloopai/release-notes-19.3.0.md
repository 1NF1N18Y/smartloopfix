...
- `wipetxes`: New command for `halfy-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/Halfyproject/compare/v19.2.0...halfypay:v19.3.0).

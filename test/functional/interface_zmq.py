...
from test_framework.messages import halfyhash, hash256
...
def halfyhash_reversed(byte_str):
    return halfyhash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], halfyhash_reversed(block[:80]).hex())

...
class LLMQCoinbaseCommitmentsTest(HalfyTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as HalfyTestFramework doesn't support this atm)

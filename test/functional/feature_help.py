...
"""Verify that starting halfyd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start halfyd with -h for help text")
        ...
        self.log.info("Start halfyd with -version for version information")
        ...
        self.log.info("Start halfydd with -fakearg to make sure it does not start")
